...
class IndexForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        placeholders = {
            ...
            'first_testimonial_partner_1': 'Primeiro nome do primeiro testemunho',
            'first_testimonial_partner_2': 'Segundo nome do primeiro testemunho',
            'second_testimonial_pic': 'Foto do segundo testemunho',
            'second_testimonial_text': 'Texto do segundo testemunho',
            'second_testimonial_partner_1': 'Primeiro nome do segundo testemunho',
            'second_testimonial_partner_2': 'Segundo nome do segundo testemunho',
            'third_testimonial_pic': 'Foto do terceiro testemunho',
            'third_testimonial_text': 'Texto do terceiro testemunho',
            'third_testimonial_partner_1': 'Primeiro nome do terceiro testemunho',
            'third_testimonial_partner_2': 'Segundo nome do terceiro testemunho',
        }

        label_fields = ['middle_text', 'first_testimonial_text', 'first_testimonial_partner_1',
                        'first_testimonial_partner_2', 'second_testimonial_text', 'second_testimonial_partner_1',
                        'second_testimonial_partner_2', 'third_testimonial_text', 'third_testimonial_partner_1',
                        'third_testimonial_partner_2']
