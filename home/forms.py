...
class IndexForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['carousell_photo_1', 'carousell_photo_2', 'carousell_photo_3', 'middle_text',
                  'middle_picture', 'prew_picture', 'w_picture', 'fam_picture']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['carousell_photo_1'].widget.attrs['autofocus'] = True
